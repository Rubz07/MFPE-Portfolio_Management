package com.pod4.DailySharePrice.controller;
...
import com.pod4.DailySharePrice.authorization.AuthorizationClient;
...
public class StockController {
	...
	public List<Stock> getAllStockDetails(@RequestHeader("Authorization") String authorization)
