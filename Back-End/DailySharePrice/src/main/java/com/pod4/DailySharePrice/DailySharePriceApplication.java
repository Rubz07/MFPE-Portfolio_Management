...
public class DailySharePriceApplication {
    ...
    public Docket configureSwagger() {
        return new Docket(DocumentationType.SWAGGER_2).select().paths(PathSelectors.ant("/DailySharePrice/**")) 
                .apis(RequestHandlerSelectors.basePackage("com.pod4.DailySharePrice.controller")).build()
                .apiInfo(apiInfo());
    }
